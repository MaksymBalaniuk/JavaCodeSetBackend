...
import ua.nix.balaniuk.javacodeset.dto.executor.ExecutionTempDataDto;
import ua.nix.balaniuk.javacodeset.dto.executor.JavaCodeExecutionResponseDto;
import ua.nix.balaniuk.javacodeset.exception.InternalExecutorException;
...
public class JavaCodeExecutor {
    ...
    private static final String ALL_ALLOWED_IMPORTS =
            """
            import java.lang.*;
            import java.util.*;
            import java.text.*;
    ...
    private String buildClassTemplate(String mainClassName, String javaCode) {
        return ALL_ALLOWED_IMPORTS + System.lineSeparator()
